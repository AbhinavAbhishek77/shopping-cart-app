    ...
    <div className=" flex justify-center">
      {cart.length > 0 ? (
        <div class="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center">
          ...
          <div class="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between" >
            <div class="flex flex-col gap-5 ">
              <div class="font-semibold text-xl text-green-800 uppercase ">Your Cart</div>
              <div class="font-semibold text-5xl text-green-700  -mt-5 uppercase">
                Summary
              </div>
              <p>
        ...
        <div class="min-h-[80vh] flex flex-col items-center justify-center">
          <h1 class="text-gray-700 font-semibold text-xl mb-2">Cart Empty</h1>
          <Link to={"/"}>
            <button class="bg-green-600 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-semibold hover:text-green-700 p-3 px-10 tracking-wider">Shop Now</button>
          </Link>
        </div>
      )}
    </div>
